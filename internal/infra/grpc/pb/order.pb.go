...
type Order struct {
	...
	FinalPrice    float32                `protobuf:"fixed32,4,opt,name=final_price,json=finalPrice,proto3" json:"final_price,omitempty"` // Considerar usar google.protobuf.Timestamp para datas
...
const file_order_proto_rawDesc = "" +
	...
	"\x03tax\x18\x02 \x01(\x02R\x03tax\"6\n" +
	...
	"\n" +
	"ListOrders\x12\x15.pb.ListOrdersRequest\x1a\x16.pb.ListOrdersResponse\"\x00B2Z0desafio-cleanarchitecture/internal/infra/grpc/pbb\x06proto3"
